...
<div class="text-center">
   <button class="text-white rounded-lg text-3xl py-2" type="button" data-drawer-target="drawer-right-example" data-drawer-show="drawer-right-example" data-drawer-placement="right" aria-controls="drawer-right-example">
  <RxHamburgerMenu/>
   </button>
</div>
